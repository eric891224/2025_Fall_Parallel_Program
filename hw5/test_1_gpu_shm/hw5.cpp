    ...
    double &min_dist)
{
    ...
    for (int step = 1; step < param::n_steps; step++)
    {
        ...
        size_t shmem_size = 4 * blockSize * sizeof(double) + blockSize * sizeof(int);
...
int main(int argc, char **argv)
{
    ...
    std::cout << "Problem 1 elapsed time: " << elapsed.count() << " seconds\n";
    ...
    std::cout << "Problem 2 elapsed time: " << elapsed2.count() << " seconds\n";
    ...
    auto t6 = clock::now();
    std::chrono::duration<double> elapsed3 = t6 - t5;
    std::cout << "Problem 3 elapsed time: " << elapsed3.count() << " seconds\n";
